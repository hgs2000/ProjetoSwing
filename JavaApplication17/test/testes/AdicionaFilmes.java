...
public class AdicionaFilmes {
    ...
    public static void main(String[] args) {
        ...
        filmes.add(new Filme(new JTextField("Dredd"),
                new JTextArea("The future America is an irradiated waste land. On its East Coast, running from Boston to Washington DC, lies Mega City One - a vast, "
                ...
                new ArrayList<JCheckBox>() {
                    {
                        add(new JCheckBox("Ação"));
                        add(new JCheckBox("Ficção Científica"));
                    }
                },
                2012));

        System.out.println("Nome:\n     " + filmes.get(0).getFilmeNome().getText() + "\n");
        System.out.println("Sinopse:\n      " + filmes.get(0).getFilmeSinopse().getText() + "\n");
        System.out.println("Gêneros do Filme:\n    -"
                + filmes.get(0).getFilmeGeneros().get(0).getText() + "\n    -" + filmes.get(0).getFilmeGeneros().get(1).getText() + "\n");
